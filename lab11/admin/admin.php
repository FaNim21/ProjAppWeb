...
function Kategorie(){ # wyświetlanie listy wszystkich kategorii z bazy danych (READ)
    global $link;
...
function ListaProdukt(){ # wyświetlanie listy wszystkich podstron z bazy danych (READ)
    global $link;
